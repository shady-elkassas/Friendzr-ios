...
@objc public protocol ImagePickerSheetControllerDelegate {
    ...
    @objc optional func controllerWillEnlargePreview(_ controller: MSImagePickerSheetController)
    @objc optional func controllerDidEnlargePreview(_ controller: MSImagePickerSheetController)
    
    @objc optional func controller(_ controller: MSImagePickerSheetController, willSelectAsset asset: PHAsset)
    @objc optional func controller(_ controller: MSImagePickerSheetController, didSelectAsset asset: PHAsset)
    
    @objc optional func controller(_ controller: MSImagePickerSheetController, willDeselectAsset asset: PHAsset)
    @objc optional func controller(_ controller: MSImagePickerSheetController, didDeselectAsset asset: PHAsset)
}
...
public class MSImagePickerSheetController: UIViewController {
    ...
    func enlargePreviewsByCenteringToIndexPath(indexPath: IndexPath?, completion: (() -> ())?) {
...
extension MSImagePickerSheetController: UICollectionViewDelegate {
    ...
    public func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if !enlargedPreviews {
            enlargePreviewsByCenteringToIndexPath(indexPath: indexPath) {
