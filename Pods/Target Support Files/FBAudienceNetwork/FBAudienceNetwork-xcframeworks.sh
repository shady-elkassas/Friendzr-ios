...
install_xcframework "${PODS_ROOT}/FBAudienceNetwork/Dynamic/FBAudienceNetwork.xcframework" "FBAudienceNetwork" "framework" "ios-arm64_x86_64-simulator" "ios-arm64_armv7"
