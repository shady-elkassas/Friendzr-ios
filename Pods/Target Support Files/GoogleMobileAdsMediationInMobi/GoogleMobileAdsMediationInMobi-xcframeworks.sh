...
install_xcframework "${PODS_ROOT}/GoogleMobileAdsMediationInMobi/InMobiAdapter-10.0.5.0/InMobiAdapter.xcframework" "InMobiAdapter" "framework" "ios-arm64_x86_64-simulator" "ios-arm64_armv7"
