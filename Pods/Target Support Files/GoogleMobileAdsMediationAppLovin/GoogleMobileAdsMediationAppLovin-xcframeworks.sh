...
install_xcframework "${PODS_ROOT}/GoogleMobileAdsMediationAppLovin/AppLovinAdapter-11.3.3.0/AppLovinAdapter.xcframework" "AppLovinAdapter" "framework" "ios-arm64_armv7" "ios-arm64_x86_64-simulator"
