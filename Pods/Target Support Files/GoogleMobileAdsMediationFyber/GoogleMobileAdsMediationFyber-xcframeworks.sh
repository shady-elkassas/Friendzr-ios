...
install_xcframework "${PODS_ROOT}/GoogleMobileAdsMediationFyber/FyberAdapter-8.1.4.0/FyberAdapter.xcframework" "FyberAdapter" "framework" "ios-arm64_x86_64-simulator" "ios-arm64_armv7"
