...
install_xcframework "${PODS_ROOT}/GoogleMobileAdsMediationFacebook/FacebookAdapter-6.9.0.1/FacebookAdapter.xcframework" "FacebookAdapter" "framework" "ios-arm64_armv7" "ios-arm64_x86_64-simulator"
