...
class AddEventViewModel {
    ...
    func addNewEvent(withTitle title:String,AndDescription description:String,AndStatus status: String,AndCategory categoryId:String,lang:Double,lat:Double,totalnumbert:String,allday:Bool,eventdateFrom:String,eventDateto:String,eventfrom:String,eventto:String,creatDate:String,creattime:String,eventTypeName:String,eventtype:String,showAttendees:Bool,listOfUserIDs:[String],attachedImg:Bool,AndImage image:UIImage,completion: @escaping (_ error: String?, _ data: EventObj?) -> ()) {
        ...
        var parameters:[String : Any] = ["Title": title,"description":description,"status":status,"categoryid":categoryId,"lang":lang,"lat":lat,"totalnumbert": totalnumbert,"allday":allday,"eventdate":eventdateFrom,"eventdateto":eventDateto,"eventfrom":eventfrom,"eventto":eventto,"CreatDate":creatDate,"Creattime":creattime,"eventtype":eventtype,"showAttendees":showAttendees]
        
        if eventTypeName == "Private" {
            if allday == true {
                parameters = ["Title": title,"description":description,"status":status,"categoryid":categoryId,"lang":lang,"lat":lat,"totalnumbert": totalnumbert,"allday":allday,"eventdate":eventdateFrom,"eventdateto":eventDateto,"CreatDate":creatDate,"Creattime":creattime,"eventtype":eventtype,"ListOfUserIDs":listOfUserIDs,"showAttendees":showAttendees]
            }else {
                parameters = ["Title": title,"description":description,"status":status,"categoryid":categoryId,"lang":lang,"lat":lat,"totalnumbert": totalnumbert,"allday":allday,"eventdate":eventdateFrom,"eventdateto":eventDateto,"eventfrom":eventfrom,"eventto":eventto,"CreatDate":creatDate,"Creattime":creattime,"eventtype":eventtype,"ListOfUserIDs":listOfUserIDs,"showAttendees":showAttendees]
            }
        }
            ...
            if allday == true {
                parameters = ["Title": title,"description":description,"status":status,"categoryid":categoryId,"lang":lang,"lat":lat,"totalnumbert": totalnumbert,"allday":allday,"eventdate":eventdateFrom,"eventdateto":eventDateto,"CreatDate":creatDate,"Creattime":creattime,"eventtype":eventtype]
            }
            else {
                parameters = ["Title": title,"description":description,"status":status,"categoryid":categoryId,"lang":lang,"lat":lat,"totalnumbert": totalnumbert,"allday":allday,"eventdate":eventdateFrom,"eventdateto":eventDateto,"eventfrom":eventfrom,"eventto":eventto,"CreatDate":creatDate,"Creattime":creattime,"eventtype":eventtype]
            }
        }
